...
const ButtonTextIconRounded = ({
  ...
  const styles = StyleSheet.create({
    ...
    } py-2 tracking-wider text-sm rounded-full`,
    btnPress: tw`py-2 text-black tracking-wider text-sm rounded-full`,
    textColor: isPress
      ? tw`text-white`
      ...
      <TouchableHighlight {...touchProps}>
        <View style={tw`flex flex-row justify-center items-center`}>
          ...
          {icon !== undefined && iconPosition === 'right' && (
            <Icon name={icon} style={[tw`ml-2`, styles.textColor]} size={15} />
          )}
        </View>
      </TouchableHighlight>
    </>
...
export default ButtonTextIconRounded;
